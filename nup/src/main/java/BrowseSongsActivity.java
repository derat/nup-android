...
public class BrowseSongsActivity extends Activity implements AdapterView.OnItemClickListener {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (mAlbum != null) {
      ...
      setTitle(getString(mOnlyCached ? R.string.browse_cached_songs : R.string.browse_songs));
    }
    ...
    new AsyncTask<Void, Void, List<Song>>() {
      ...
      protected List<Song> doInBackground(Void... args) {
        return NupActivity.getService()
            .getSongDb()
            .query(mArtist, null, mAlbum, mAlbumId, mMinRating, false, false, mOnlyCached);
      }
              ...
              new Comparator<Song>() {
                ...
                public int compare(Song a, Song b) {
                  return Util.getSortingKey(a.getTitle(), Util.SORT_TITLE)
                      .compareTo(Util.getSortingKey(b.getTitle(), Util.SORT_TITLE));
                }
              });
        }
        mSongs = songs;
  ...
  public void onItemClick(AdapterView parent, View view, int position, long id) {
    ...
    if (song == null) return;
    NupActivity.getService().appendSongToPlaylist(song);
    Toast.makeText(this, getString(R.string.appended_song_fmt, song.getTitle()), Toast.LENGTH_SHORT)
        .show();
  }
