...
public class PlaybackReporter {
  ...
  public void reportPendingSongs() {
    ...
    List<SongDatabase.PendingPlaybackReport> reports = mSongDb.getAllPendingPlaybackReports();
    ...
    try {
      ...
      conn =
          mDownloader.download(
              mDownloader.getServerUrl(path), "POST", Downloader.AuthType.SERVER, null);
