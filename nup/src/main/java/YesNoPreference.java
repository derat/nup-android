...
class YesNoPreference extends DialogPreference implements NupService.SongDatabaseUpdateListener {
  ...
  public void onSongDatabaseUpdate() {
    if (NupPreferences.SYNC_SONG_LIST.equals(getKey())) updateSyncMessage();
  }
    ...
    protected void onPreExecute() {
      mDialog =
          ProgressDialog.show(
              ...
              mContext.getResources().getQuantityString(R.plurals.sync_update_fmt, 0, 0),
              true, // indeterminate
              true); // cancelable
    ...
    protected void onProgressUpdate(Integer... progress) {
      ...
      switch (state) {
        ...
        case DELETING_SONGS:
          ...
          break;
        case UPDATING_STATS:
          mDialog.setMessage(mContext.getString(R.string.sync_progress_rebuilding_stats_tables));
          break;
      }
    }
