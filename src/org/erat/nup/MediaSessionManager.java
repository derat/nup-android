...
public class MediaSessionManager {
    ...
    public void updateSong(Song song) {
        ...
        if (song != null) {
            ...
            if (song.getRating() >= 0.0) {
                builder.putRating(MediaMetadata.METADATA_KEY_RATING,
            ...
            if (bitmap != null) {
                ...
                builder.putBitmap(MediaMetadata.METADATA_KEY_ALBUM_ART, bitmap.copy(bitmap.getConfig(), true));
            }
        }
    ...
    public void updatePlaybackState(Song song,
                                    boolean paused,
        ...
        if (song != null) {
            builder.setActiveQueueItemId(song.getSongId());
        }
        ...
        if (numSongs > 0) {
            if (buffering) {
                ...
                state = (songIndex == numSongs - 1) ?
                    PlaybackState.STATE_STOPPED : PlaybackState.STATE_SKIPPING_TO_NEXT;
            } else {
