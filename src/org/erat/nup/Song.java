...
class Song implements Serializable {
    ...
    private final int mLengthSec, mTrackNum;
    ...
    public Song(int songId, String artist, String title, String album, String filename,
                int lengthSec, int trackNum, double rating) {
        mSongId = songId;
        mArtist = artist;
        mTitle = title;
        mAlbum = album;
